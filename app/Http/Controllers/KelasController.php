...
class KelasController extends Controller
{
    ...
    public function info($id){
        ...
        $kelas = Kelas::find($id);
        $teacher = DB::table('users')->select('users.name','users.id')->join('schools','schools.id','=','users.schools_id')->join('kelas','kelas.schools_id','=','schools.id')->where('kelas.id',$id)->whereNotIn('users.id',$ls)->get();
